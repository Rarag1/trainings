...
$jobs = [
  [
    'name'=>'Архитектор виртуальных миров',
    'start_date'=>'близкое будущее -----',
    'end_date'=>'далекое будущее',
    'description'=>'Разработка физических, социальных и других законов миров.<br>
    Создание и исследование алгоритмов развития сложных адптивных систем внутри миров и определение необходимых внешних воздействий.<br>
    Проработка вариативности векторов саморазвития персонажей.'
  ],
  [
  'name'=>'Сторож',
  'start_date'=>'2022 -----',
  'end_date'=>'2022',
  'description'=>'Время научиться новому в ИТ.'
  ],
  [
  'name'=>'Фриланс',
  'start_date'=>'2010 -----',
  'end_date'=>'2020',
  'description'=>'Партнерство, инвестиции, саморазвитие.'
  ],
  [
  'name'=>'Инструктор по древнеславянской гимнастике',
  'start_date'=>'2005 -----',
  'end_date'=>'2007',
  'description'=>'Оздоровление себя и близких.'
  ],
  [
  'name'=>'Бухгалтер',
  'start_date'=>'1999 -----',
  'end_date'=>'2000',
  'description'=>'Практика получаемого образования.'
  ]
]
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?=$job['start_date']?><span class="w3-tag w3-teal w3-round"></span><?=$job['end_date']?>
              <?php if ($job['end_date'] == '2022'):?><span class="w3-tag w3-teal w3-round">curent</span><?php endif;?>
            </h6><p><?=$job['description']?></p>
            <hr>
          </div>
          <?php endforeach;?>
